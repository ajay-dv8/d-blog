			...
			>
				<div className="border-b p-5 flex items-center sm:justify-between flex-wrap sm:flex-row gap-2">
					...
					<Button
						...
						className={cn(
							"flex gap-2 items-center border px-3 py-2 rounded-md border-purple-500 disabled:border-gray-800  bg-zinc-800 transition-all group text-sm disabled:bg-gray-900",
								...
								<FormControl>
									...
									>
										<Input
											...
											{...field}
											className={cn(
												"border-none text-lg font-medium leading-relaxed focus:ring-1 ring-indigo-600 ",
												isPreview
													? "w-0 p-0"
													: "w-full lg:w-1/2"
											)}
							...
							<FormControl>
								...
								>
									<Textarea
										...
										{...field}
										className={cn(
											"border-none text-lg font-medium leading-relaxed focus:ring-1 ring-indigo-600  h-70vh resize-none",
											isPreview
												? "w-0 p-0"
												: "w-full lg:w-1/2"
										)}
